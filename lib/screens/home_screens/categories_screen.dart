              ...
              children: [
                StreamBuilder<QuerySnapshot<ExpenseModel>>(
                  stream: FbFirestoreController()
                      .readBasicSupplies('Basic Supplies'),
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      double totalExpenseAmount =
                          snapshot.data!.docs.fold(0.0, (sum, item) {
                        try {
                          ...
                          print(
                              'Error parsing expenseAmount: ${item.data().expenseAmount}, skipping...');
...
*/
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) => DetailsItemScreen(
                                          type: 'مستلزمات اساسية',
                                          cost: totalExpenseAmount.toString(),
                                          docId: snapshot
                                              .data!.docs[0].reference.id,
                                          ceiling: snapshot.data!.docs[0]
                                              .data()
                                              .ceiling,
                                          collection: 'Basic Supplies',
                                        ),
                                      ),
                                    );
                                  },
                ...
                StreamBuilder<QuerySnapshot<ExpenseModel>>(
                  stream: FbFirestoreController()
                      .readBasicSupplies('Entertainment'),
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      return Container(
                        padding: EdgeInsets.symmetric(
...
*/
                ...
                StreamBuilder<QuerySnapshot<ExpenseModel>>(
                  stream: FbFirestoreController()
                      .readBasicSupplies('Transportation'),
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      return Container(
                        padding: EdgeInsets.symmetric(
                            ...
                            return Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  AppText(
                                    text:
                                        '${snapshot.data!.docs[index].data().expenseAmount}',
                                    color: AppColors.primaryColor,
                                  ),
                                  /*InkWell(
                                  onTap :(){
